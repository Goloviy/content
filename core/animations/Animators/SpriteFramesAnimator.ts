import { Sprite, Texture, Ticker } from 'Core/abstractions'
import { MathCore } from 'Core/animations/MathCore/MathCore'
import { AnimationJSON, AnimatorType, CustomEvent, CustomEventType } from 'Core/animations/ObjectTypes/AnimatedObjectTypes'
...
export class SpriteFramesAnimator implements IAnimator {
  ...
  animatorType: AnimatorType = AnimatorType.SpriteFramesAnimator
  startDelay: number
