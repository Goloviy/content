import { AnimationJSON, CurveType, CustomEvent, CustomEventType } from './AnimatedObjectTypes'
import { AnimationCurve } from './AnimationCurve'
import { AnimationCurveTransform, AnimationProperty } from './AnimationCurveTransform'
import { Event } from './Event'
import { Point, Ticker, Transform } from 'pixi.js-legacy'
...
export class TransformAnimator implements IAnimator {
  ...
  Play(): void {
    this.currentTime = 0
    this.isPlaying = true
    this.from = new Point(this.target.position.x, this.target.position.y)
